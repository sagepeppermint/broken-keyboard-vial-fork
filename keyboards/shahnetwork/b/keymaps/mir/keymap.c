...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_5x7( // DWARF HRM
        ...
        LT(5, KC_ESC), _______, LT(4, KC_SPACE), LT(6, KC_TAB),
        LT(8, KC_ENT), LT(7, KC_BSPC), _______, LT(9, KC_DEL), 
        _______, _______, _______
    ...
    [5] = LAYOUT_5x7( // MEDIA
        ...
        _______, DF(0), DF(1), DF(2), DF(3), QK_BOOT, _______,
            _______, _______, _______, _______, _______, _______, _______,
    ...
    [7] = LAYOUT_5x7( // NUMBER
        ...
        _______, KC_SLASH, KC_4, KC_5, KC_6, KC_EQL, _______,
            _______, KC_HYPR, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, _______,
      ...
      [8] = LAYOUT_5x7( // SYMBOL
        ...
        _______, KC_QUESTION, KC_DLR, KC_PERC, KC_CIRC, KC_PLUS, _______,
            _______, KC_HYPR, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, _______,

        _______, KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_PIPE, _______,
            _______, _______, _______, _______, _______, _______, _______,

        _______, _______, _______, 
        KC_LPRN, _______, KC_RPRN, KC_UNDS,
        _______, _______, _______, _______, 
        _______, _______, _______

    ),

    [9] = LAYOUT_5x7( // FUCNTION
        _______, _______, _______, _______, _______, _______, _______,
            _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS, _______,
            _______, _______, _______, _______, _______, _______, _______,

        _______, _______, _______, 
        KC_APP, _______, KC_SPC, KC_TAB,
        _______, _______, _______, _______, 
        _______, _______, _______
