...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3( // DWARF WIN
        ...
        KC_ESC, KC_F, KC_L, KC_H, KC_D, KC_V,
            KC_Z, KC_G, KC_O, KC_U, KC_DOT, KC_DEL,
        
        KC_TAB, KC_S, KC_R, KC_N, KC_T, KC_M,
            KC_P, KC_Y, KC_E, KC_I, KC_A, KC_LGUI,
        
        KC_LCPO, KC_X, KC_J, KC_B, KC_K, KC_Q,
            KC_C, KC_W, KC_QUOTE, KC_COMMA, KC_SEMICOLON, KC_RCPC,
     ...
     [1] = LAYOUT_split_3x6_3( // QWERTY WIN
        ...
        KC_LCPO, KC_Z, KC_X, KC_C, KC_V, KC_B,
            KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RCPC,
     ...
     [5] = LAYOUT_split_3x6_3( // LEFT MAC
        ...
        _______, G(KC_Z), G(KC_X), G(KC_C), G(KC_V), KC_F3,
