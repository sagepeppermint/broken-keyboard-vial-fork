...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_all( // dwarf hrm
    ...
    LT(4, KC_BSPC), KC_X, KC_J, KC_B, KC_K, KC_Q,    KC_C, KC_W, KC_QUOTE, KC_COMMA, KC_SEMICOLON, KC_DEL,                            KC_UP,
	KC_LGUI,          KC_LALT,          KC_LSFT,  MO(3),          KC_SPC,           KC_LCTL,                           KC_LEFT, KC_DOWN, KC_RGHT 
  ),
