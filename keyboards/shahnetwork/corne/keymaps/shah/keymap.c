...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    XXXXXXX, KC_SLSH, KC_4, KC_5, KC_6, KC_EQL,                    KC_CAPS, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, XXXXXXX,
    XXXXXXX, KC_GRV, KC_1, KC_2, KC_3, KC_BSLS,                      XXXXXXX, SELECTWORD, CAPS_WORD_LOCK, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    XXXXXXX, KC_QUESTION, KC_DOLLAR, KC_PERCENT, KC_CIRCUMFLEX, KC_PLUS,        KC_CAPS, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, XXXXXXX,
    XXXXXXX, KC_TILDE, KC_EXCLAIM, KC_AT, KC_HASH, KC_PIPE,                     XXXXXXX, SELECTWORD, CAPS_WORD_LOCK, XXXXXXX, XXXXXXX, XXXXXXX,
