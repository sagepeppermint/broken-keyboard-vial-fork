...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT, LT(6, KC_X), KC_J, KC_B, KC_K, KC_Q,                               KC_C, KC_W, KC_QUOTE, KC_COMMA, LT(6, KC_SEMICOLON), KC_RSFT,
                              KC_ESC, LT(4, KC_SPACE), LT(5, KC_TAB),           LT(3, KC_ENT), LT(2, KC_BSPC), LT(7, KC_DEL)
    ),
    ...
    KC_LSFT, LT(6, KC_Z), KC_X, KC_C, KC_V, KC_B,                               KC_N, KC_M, KC_COMMA, KC_DOT, LT(6, KC_SLASH), KC_RSFT,
                              KC_ESC, LT(4, KC_SPACE), LT(5, KC_TAB),           LT(3, KC_ENT), LT(2, KC_BSPC), LT(7, KC_DEL)
    ),
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), XXXXXXX,
    ...
    [5] = LAYOUT_split_3x6_3( // media
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), XXXXXXX,
    XXXXXXX, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_CAPS,                   KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, TO(0), TO(1), XXXXXXX, RESET, QK_BOOT,
                            _______, _______, _______,                      KC_MUTE, KC_MPLY, KC_MSTP
    ),

    [6] = LAYOUT_split_3x6_3( // shortcut
    XXXXXXX, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), XXXXXXX,                      XXXXXXX, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), XXXXXXX,
    XXXXXXX, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_CAPS,                      KC_CAPS, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, XXXXXXX,
    XXXXXXX, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), LSG(KC_S),                    XXXXXXX, C(KC_V), C(KC_C), C(KC_X), C(KC_Z), XXXXXXX,
                                          _______,   _______,  _______,     _______, _______, _______
    ),

    [7] = LAYOUT_split_3x6_3( // function
    XXXXXXX, KC_F9, KC_F10, KC_F11, KC_F12, KC_PAUS,                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, KC_F5, KC_F6, KC_F7, KC_F8, KC_SCRL,                   KC_CAPS, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI, XXXXXXX,
    XXXXXXX, KC_F1, KC_F2, KC_F3, KC_F4, KC_PSCR,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                        KC_APP,   KC_SPACE,  KC_TAB,                _______, _______, _______
    )
...
uint16_t get_tapping_term(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case LT(2, KC_BSPC):
        case LT(7, KC_DEL):
            return TAPPING_TERM; // same, could reduce to 175
        default:
            return TAPPING_TERM;
    }
};
...
bool pre_process_record_user(uint16_t keycode, keyrecord_t* record) {
    // enable global quick tap before other processing
